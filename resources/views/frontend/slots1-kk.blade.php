...
<div class="container content">
	<div class="row">
		<div class="col-md-12">
			...
			<h3 class="pull-left lh">OUTDOOR FOOTBALL 5V5<br><big><span class="text-danger">{{ date('d F, Y - l',strtotime(Session::get('bookingdate'))) }}</span></big>
			<br><a class="gray"  style="cursor:pointer; text-decoration: underline" href="#">VENUE:  Yayasan Sabah Futsal Court [COURT 3]</a>
			...
			<tr>
				...
				<tr @if($timeslot->block == 1) class="danger" @endif>
					...
					@endif
					 - {{10-FHelper::bookingcount(2,$timeslot->id)}}/10 
					@endif
					</td>
					<!-- <td>
					@if(strtotime(date('Y-m-d H:i:s', strtotime(Session::get('bookingdate').' '.$timeslot->end))) <= strtotime(\Carbon\Carbon::now()->addMinutes(0)))
