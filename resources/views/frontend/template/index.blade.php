...
<html lang="en-US">
  ...
  <head>
    ...
    <link rel='stylesheet' id='azexo-css' href='{{url()}}/public/frontend/css/azexo.css' type='text/css' media='all' />
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css">
    @yield('style')
    <link rel="stylesheet" href="{{url()}}/public/frontend/css/js_composer.min.css">
                ...
                <div class="scoped-style">
                  <div class="vc_row wpb_row vc_row-fluid vc_custom_1444144697786">
                    <div class="row">
                      <div class="h-padding-0 wpb_column vc_column_container vc_col-sm-12">
                        <div class="wpb_wrapper">
                          <div class="panel  social">
                            ...
                            <div class="entry ">
                              <!--   <div class="entry-icon"><a class="" href="https://www.facebook.com/wwstadium/"><span class="fa fa-facebook"></span></a>
                            </div> -->
                          ...
                          <!-- entry -->
                          <div class="entry ">
                            <!--  <div class="entry-icon"><a class="" href="https://www.instagram.com/supersquadsoccer/"><span class="fa fa-instagram"></span></a>
                          </div> -->
                          <div class="entry-data">
                            <div class="entry-header"></div>
                        ...
                        <!-- entry -->
                        <div class="entry ">
                          <div class="entry-icon"><a class="" href="https://api.whatsapp.com/send?phone=6738237789"><span class="fa fa-phone" style="align-content: center;"></span></a>
                        </div>
                        <div class="entry-data">
                          <div class="entry-header"></div>
                      ...
                      <div class="entry ">
                        <!-- <div class="entry-icon"><a class="" href="https://chat.whatsapp.com/2EQooLEnxtCDJWejzBbUGC" style="font-family: Arial, Helvetica, sans-serif; font-size: 11px"><span class="fa fa-4x fa-whatsapp"></span>&nbsp Join Whatsapp Group</a>
                      </div> -->
                      <div class="entry-data">
                        <div class="entry-header"></div>
                        <!-- header -->
...
<div class="header-main clearfix">
  <div class="container">
    <a class="site-title" href="{{url()}}" rel="home" ><img src="{{url()}}/public/frontend/images/2021/logo-final.png" style="width: auto; max-height: 150px;" alt="logo">
    </a>
        ...
        {{-- <li id="menu-item-492" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-492">
          ...
          <ul class="sub-menu">
            <li id="menu-item-640" class="menu-item menu-item-type-post_type menu-item-object-page  page_item page-item-2 menu-item-640">
              <a href="{{url()}}/tnc_indi" class="menu-link">Terms & Conditions</a>
            </li>
          </ul>
        </li> --}}

        <li id="menu-item-492" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-492">
          <a href="" class="menu-link">Book Game</a>
          <ul class="sub-menu">
            <li id="menu-item-640" class="menu-item menu-item-type-post_type menu-item-object-page  page_item page-item-2 menu-item-640">
              <a href="{{url()}}/timeslot1" class="menu-link">TUE 09 Mar (PPSB | 7v7)</a>
            </li>
            <li id="menu-item-640" class="menu-item menu-item-type-post_type menu-item-object-page  page_item page-item-2 menu-item-640">
              <a href="{{url()}}/timeslot2" class="menu-link">WED 10 Mar (PPSB | 7v7)</a>
            </li>
            <li id="menu-item-640" class="menu-item menu-item-type-post_type menu-item-object-page  page_item page-item-2 menu-item-640">
              <a href="{{url()}}/timeslot3" class="menu-link">FRI 12 Mar (PPSB | 7v7)</a>
            </li>
          </ul>
        </li>

        {{-- <li id="menu-item-492" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-492">
          <a href="#menu" class="menu-link">Rankings</a>
          <ul class="sub-menu">
            <li id="menu-item-640" class="menu-item menu-item-type-post_type menu-item-object-page  page_item page-item-2 menu-item-640">
              <a href="{{url()}}/ranking" class="menu-link">Leaderboard</a>
            </li>
          </ul>
        </li> --}}
      ...
      <ul id="primary-menu" class="nav-menu">
        ...
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-476">
          <a href="{{url()}}/notifications" class="menu-link">
            <i style="font-size: 25px; " class="fa fa-5x fa-globe"></i><span class="label label-danger count">{{App\User::find(Auth::user()->id)->countNotificationsNotRead()}}</span>
          </a>
        </li>
        @endif
        <li id="menu-item-492" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-492">
        <a href="#menu" class="menu-link">Hi, {{Auth::user()->name}}</a>
          <ul class="sub-menu">
            ...
            @else
            <li id="menu-item-532" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-532">
              <a href="{{url()}}/backend" class="menu-link">Dashboard</a>
            </li>
            <li id="menu-item-532" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-532">
              <a href="{{url()}}/logout" class="menu-link">Logout</a>
            </li>
